        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-12 text-center md:text-left my-auto">
            ...
            <div class="max-w-4xl md:ml-1 animate-enter delay-200">
                ...
                <div class="flex flex-col xl:flex-row gap-4 items-center xl:items-stretch animate-enter delay-300">
                    ...
                    <div class="bg-black/50 backdrop-blur-md border border-white/20 rounded flex flex-col sm:flex-row items-center justify-center px-4 md:px-6 py-3 gap-2 md:gap-4 shadow-xl w-full xl:w-auto overflow-hidden">
