...
<body class="bg-black text-white overflow-x-hidden">
    ...
    <section class="hero-section flex flex-col pt-[110px] pb-12 sm:pt-[130px] md:pt-[100px] relative overflow-hidden min-h-screen">
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-12 text-center md:text-left my-auto">
            ...
            <div class="max-w-4xl md:ml-1 animate-enter delay-200">
                ...
                <!-- ZMĚNA LAYOUTU PRO IPAD: Fixní min-h-[64px] pro garantovanou fyzickou výšku bloků -->
                <div class="flex flex-wrap gap-4 items-center justify-center md:justify-start animate-enter delay-300">
                    <div class="flex flex-row gap-3 w-full md:w-auto flex-1 md:flex-none">
                        <?php if ($dailyMenuUrl): ?>
                        <a href="<?= $dailyMenuUrl ?>" class="min-h-[64px] flex-1 md:flex-none bg-brand-gold text-black font-bold font-heading px-2 sm:px-6 rounded hover:bg-white transition shadow-lg shadow-amber-900/40 uppercase tracking-widest flex flex-col items-center justify-center transform hover:scale-105 duration-200 text-center leading-none gap-1 whitespace-nowrap min-w-[140px]">
                            <span class="text-base sm:text-lg mt-1">DENNÍ MENU</span>
                    ...
                    <div class="min-h-[64px] bg-black/50 backdrop-blur-md border border-white/20 rounded flex flex-col sm:flex-row items-center justify-center px-4 md:px-6 py-2 gap-1 md:gap-4 shadow-xl w-full md:w-auto overflow-hidden flex-1 md:flex-none">
    ...
    <section id="denni-menu" class="bg-black py-20 px-8 md:px-12 relative">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white/5 border border-white/10 p-8 md:p-12 rounded-sm shadow-xl max-w-3xl mx-auto scroll-wait delay-100 text-center relative overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-br from-black/40 to-transparent pointer-events-none"></div>
                <div class="relative z-10">
                    <div class="text-brand-gold text-4xl md:text-5xl mb-6">
                        <i class="fas fa-calendar-alt"></i>
                    </div>
                    <h3 class="text-2xl md:text-3xl font-heading font-bold text-white mb-4 tracking-wider uppercase">Dnešní polední nabídka</h3>
                    <p class="text-gray-300 font-light text-sm md:text-base mb-8 max-w-xl mx-auto">Každý všední den pro vás připravujeme čerstvé obědové menu. Zastavte se na oběd, nebo si objednejte s sebou.</p>
